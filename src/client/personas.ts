...
export const BUILTIN_PERSONAS: ReadonlyArray<{ id: string; name: string; copy: CopyTable }> = [
  {
    ...
    copy: {
      ...
      tapHead: ['哼、哼才不是舒服呢！', '就、就允许你摸一下头！'],
      tapLeg: ['哼！才不是给你摸的！', '笨蛋！谁让你碰腿了！'],
      tapArm: ['牵、牵手才没有很开心！', '击掌就击掌，笨蛋！'],
      tapBody: ['摸、摸够了没有！', '再乱摸真生气了哦，笨蛋！'],
    },
  },
  {
    id: 'genki',
    ...
    copy: {
      ...
      tapHead: ['好舒服再来再来！', '摸头头能量满格！'],
      tapLeg: ['痒痒痒哈哈别闹！', '腿腿要跑掉啦！'],
      tapArm: ['击掌！耶！', '牵手手出发喽！'],
      tapBody: ['嘿嘿好痒！', '再戳我要跳起来啦！'],
    },
  },
  {
    id: 'airhead',
    ...
    copy: {
      ...
      tapHead: ['咦，好舒服…', '摸头…会变聪明吗…'],
      tapLeg: ['咦，那是腿…', '痒痒…哈哈哈…'],
      tapArm: ['牵手…好哦…', '击掌…啪…'],
      tapBody: ['咦嘿嘿…', '别戳啦，会歪掉的…'],
    },
  },
  {
    id: 'kuudere',
  ...
  },
  {
    ...
    copy: {
      ...
      tapHead: ['摸头好舒服~嗯~', '最喜欢摸头了~'],
      tapLeg: ['腿腿也会害羞的~', '轻轻的哦~'],
      tapArm: ['牵手~好温暖~', '击掌！耶~'],
      tapBody: ['嘿嘿~今天累了吗？', '温柔一点哦~'],
    },
  },
  {
    id: 'yandere',
    ...
    copy: {
      ...
      tapHead: ['摸头…只准你摸哦…', '嘿嘿…再摸嘛…'],
      tapLeg: ['那里…只属于你…', '再摸…就缠上你了哦…'],
      tapArm: ['牵住…就不放手了…', '击掌…约定好了哦…'],
      tapBody: ['嘿嘿…最喜欢你了…', '再摸…要给你更多哦…'],
    },
  },
]
